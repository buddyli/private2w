...
$(function(){
	...
	$('#frm_add_content').submit(function(){
		...
		for(var i=0; i<tmp.length; i++){
			...
			var indexed = $("input[name^='item_indexed_']", tmp[i]).val()
			// alert(input+","+text+","+indexed)
			var objJson = "{'"+text+"':'"+input+"','indexed':'"+indexed+"'}"
		}
	})
})
</script>
...
<body>
	<div class="box">
		<h1>添加内容</h1>
		<form name="frm_add_content" id="frm_add_content" action="" method="post">
			<table>
				<tr>
